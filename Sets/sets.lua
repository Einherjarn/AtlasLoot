AtlasLootSetItems = {
   ...
   T1Paladin = {
    ...
    PVPWeapons2 = {
		...
		ROLTheldren = {
        { 22047, "inv_jewelry_necklace_28", "=q1=Top Piece of Lord Valthalak's Amulet", "Quest Item", "100%" },
		{ 0, "", "", "" },
		{ 22305, "inv_shoulder_05", "=q3=Ironweave Mantle", "Shoulder, Cloth", "38%" },
		{ 22318, "inv_weapon_bow_12", "=q3=Malgen's Long Bow", "Ranged, Bow", "26%" },
		{ 22330, "inv_misc_cape_16", "=q3=Shroud of Arcane Mastery", "Back", "19%" },
		{ 22317, "inv_gauntlets_11", "=q3=Lefty's Brass Knuckle", "One-hand, Fist Weapon", "17%" },
        };
    };
