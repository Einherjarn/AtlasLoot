			    ...
			    for i = 1, 27, 1 do
				    ...
				    if(AtlasLootBossButtons[zoneID][i] ~= nil and AtlasLootBossButtons[zoneID][i] ~= "") then
					    ...
					    if(getglobal("AtlasText_"..i):GetText() == nil and getglobal("AtlasText_"..i-1):GetText() == nil and getglobal("AtlasText_"..i-2):GetText() ~= nil) then
							...
							elseif(zoneID == "BlackrockDepths") then
                                getglobal("AtlasBossLine_"..i.."_Text"):SetText(GREY..ATLASLOOT_BRD_ARENA);
...
function AtlasLoot_ShowItemsFrame(dataID, dataSource, boss, pFrame)
	...
	getglobal("AtlasLoot_BRDBossButton"):Hide();
	...
	elseif(dataID=="BRDBoss") then
        AtlasLoot_Set("BRDBoss");
    else
	    for i = 1, 30, 1 do
		...
		getglobal("AtlasLootItemsFrame_brd1"):Hide();
		getglobal("AtlasLootItemsFrame_brd2"):Hide();
		getglobal("AtlasLootItemsFrame_brd3"):Hide();
		getglobal("AtlasLootItemsFrame_brd4"):Hide();
		getglobal("AtlasLootItemsFrame_brd5"):Hide();
		getglobal("AtlasLootItemsFrame_brd6"):Hide();
		getglobal("AtlasLootItemsFrame_brd7"):Hide();
		getglobal("AtlasLootItemsFrame_brd8"):Hide();
