function AtlasLoot_SetMenu(setname)
    ...
    elseif(setname=="PVPSET") then
        ...
        AtlasLootItemsFrame:Show();
	elseif(setname=="BRDBoss") then
        getglobal("AtlasLootItemsFrame_brd1"):Show();
        getglobal("AtlasLootItemsFrame_brd1").lootpage="ROLGorosh";
		getglobal("AtlasLootItemsFrame_brd2"):Show();
        getglobal("AtlasLootItemsFrame_brd2").lootpage="ROLGrizzle";
		getglobal("AtlasLootItemsFrame_brd3"):Show();
        getglobal("AtlasLootItemsFrame_brd3").lootpage="ROLEviscerator";
		getglobal("AtlasLootItemsFrame_brd4"):Show();
        getglobal("AtlasLootItemsFrame_brd4").lootpage="ROLOkthor";
		getglobal("AtlasLootItemsFrame_brd5"):Show();
        getglobal("AtlasLootItemsFrame_brd5").lootpage="ROLAnubshiah";
		getglobal("AtlasLootItemsFrame_brd6"):Show();
        getglobal("AtlasLootItemsFrame_brd6").lootpage="ROLHedrum";
		getglobal("AtlasLootItemsFrame_brd7"):Show();
        getglobal("AtlasLootItemsFrame_brd7").lootpage="ROLSavGlad";
		getglobal("AtlasLootItemsFrame_brd8"):Show();
        getglobal("AtlasLootItemsFrame_brd8").lootpage="ROLTheldren";
        getglobal("AtlasLootItemsFrame_NEXT"):Hide();
        getglobal("AtlasLootItemsFrame_PREV"):Hide();
        getglobal("AtlasLootItemsFrame_BACK"):Hide();
        getglobal("AtlasLootItemsFrame_BACK").setname="BRDBoss";
        AtlasLoot_BossName:SetText("|cffFFFFFF"..ATLASLOOT_BRD_ARENA);
        AtlasLootItemsFrame:Show();
    end
    for i=1, 30, 1 do
