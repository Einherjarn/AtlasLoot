...
AtlasLootItems = {
	...
	MCTrashMobs = {
		...
		{ 16819, "inv_bracer_09", "=q4=Vambraces of Prophecy",   "=q1=#m1# =ds=#c5#", "0.16%" },
		...
		{ 16840, "inv_bracer_16", "=q4=Earthfury Bracers",       "=q1=#m1# =ds=#c7#", "0.06%" },
	...
	AQ20Andorov = {
		{ 22219,"inv_scroll_03","=q1=Plans: Jagged Obsidian Shield","Blacksmithing (300)" },
		{ 22221,"inv_scroll_03","=q1=Plans: Obsidian Mail Tunic","Blacksmithing (300)" },
		};
	AQ20CAPTIAN = {
    ...
    AQEnchants = {
	 ...
	 AQ40Rings = {
		{ 0, "INV_Misc_Bag_09", "=q6=Neutral", "" },
		{ 21196, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Protector" },
		{ 21201, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Conqueror" },
		{ 21206, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Invoker" },
		{ 0,"","","" },
		{ 0, "INV_Misc_Bag_09", "=q6=Friendly", "" },
		{ 21197, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Protector" },
		{ 21202, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Conqueror" },
		{ 21207, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Invoker" },
		{ 0,"","","" },
		{ 0, "INV_Misc_Bag_09", "=q6=Honored", "" },
		{ 21198, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Protector" },
		{ 21203, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Conqueror" },
		{ 21208, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Invoker" },
		{ 0,"","","" },
		{ 0, "INV_Misc_Bag_09", "=q6=Revered", "" },
		{ 21199, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Protector" },
		{ 21204, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Conqueror" },
		{ 21209, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Invoker" },
		{ 0,"","","" },
		{ 0, "INV_Misc_Bag_09", "=q6=Exalted", "" },
		{ 21200, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Protector" },
		{ 21205, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Conqueror" },
		{ 21210, "inv_jewelry_ring_40", "=q4=Signet Ring of the Bronze Dragonflight", "=ds=#s13#, Invoker" },
	 };
    ...
    GnMekgineerThermaplugg = {
		...
		{ 0, "", "", "" },
		{ 7742, "inv_scroll_03", "=q1=Schematic: Gnomish Cloaking Device", "Engineering (200)", "2%" },
		{ 4411, "inv_scroll_03", "=q2=Schematic: Flame Deflector", "Engineering (125)", "2%" },
		{ 4413, "inv_scroll_03", "=q2=Schematic: Discombobulator Ray", "Engineering (160)", "2%" },
		{ 4415, "inv_scroll_03", "=q3=Schematic: Craftsman's Monocle", "Engineering (185)", "2%" },
        };
   ...
   WCDeviateFaerieDragon = {
    ...
    BRDHighInterrogatorGerstahn = {
		...
		{ 0, "", "", "" },
		{ 11140, "inv_misc_key_10", "=q1=Prison Cell Key", "Key", "100%" },
        };
        
    -- BRDArena = {
        -- { 0, "INV_Misc_Bag_09", "=q6=Gorosh the Dervish", "" },
        -- { 22257, "inv_jewelry_ring_36", "=q3=Bloodclot Band", "=ds=#s13#", "35%" },
        -- { 22271, "inv_pants_leather_21", "=q3=Leggings of Frenzied Magic", "=ds=#s11#, #a1#", "35%" },
        -- { 11726, "inv_chest_chain_15", "=q4=Savage Gladiator Chain", "=ds=#s5#, #a3#", "15%" },
        -- { 22266, "inv_spear_01", "=q3=Flarethorn", "=ds=#h1# #w4#", "15%" },
        -- { 0, "INV_Misc_Bag_09", "=q6=Grizzle", "" },
        -- { 11610, "inv_scroll_03", "=q3=Plans: Dark Iron Pulverizer", "=ds=#p2# (265)", "100%" },
		-- { 11702, "inv_axe_12", "=q3=Grizzle's Skinner", "Main-Hand Axe", "35%" },
		-- { 11703, "inv_belt_16", "=q3=Stonewall Girdle", "Waist, Plate", "35%" },
		-- { 11722, "inv_shoulder_30", "=q3=Dregmetal Spaulders", "Shoulder, Plate", "15%" },
		-- { 22270, "inv_boots_plate_02", "=q3=Entrenching Boots", "Feet, Plate", "15%" },
		-- { 0, "INV_Misc_Bag_09", "=q6=Eviscerator", "" },
		-- { 11679, "inv_bracer_13", "=q3=Rubicund Armguards", "Wrist, Mail", "35%" },
		-- { 11685, "inv_shoulder_13", "=q3=Splinthide Shoulders", "Shoulder, Leather", "35%" },
		-- { 11686, "inv_belt_12", "=q3=Girdle of Beastial Fury", "Waist, Leather", "15%" },
		-- { 11730, "inv_gauntlets_04", "=q3=Savage Gladiator Grips", "Hands, Mail", "15%" },
		-- { 0, "INV_Misc_Bag_09", "=q6=Ok'thor the Breaker", "" },
		-- { 11662, "inv_belt_29", "=q3=Ban'thok Sash", "Waist, Cloth", "35%" },
		-- { 11665, "inv_gauntlets_15", "=q3=Ogreseer Fists", "Gloves, Leather", "35%" },
		-- { 11728, "inv_pants_03", "=q3=Savage Gladiator Leggings", "Legs, Mail", "15%" },
		-- { 11824, "inv_jewelry_ring_08", "=q3=Cyclopean Band", "Ring", "15%" },
		-- { 0, "INV_Misc_Bag_09", "=q6=Anub'shiah", "" },
		-- { 11675, "inv_boots_01", "=q3=Shadefiend Boots", "Feet, Leather", "35%" },
		-- { 11677, "inv_misc_cape_19", "=q3=Graverot Cape", "Back", "35%" },
		-- { 11678, "inv_chest_plate08", "=q3=Carapace of Anub'shiah", "Chest, Plate", "15%" },
		-- { 11731, "inv_boots_01", "=q3=Savage Gladiator Greaves", "Feet, Mail", "15%" },
		-- { 0, "INV_Misc_Bag_09", "=q6=Hedrum the Creeper", "" },
		-- { 11633, "inv_chest_plate02", "=q3=Spiderfang Carapace", "Chest, Plate", "35%" },
		-- { 11634, "inv_gauntlets_12", "=q3=Silkweb Gloves", "Hands, Cloth", "35%" },
		-- { 11635, "inv_weapon_shortblade_10", "=q3=Hookfang Shanker", "Dagger", "15%" },
		-- { 11729, "inv_helmet_01", "=q3=Savage Gladiator Helm", "Head, Mail", "15%" },
		-- { 0, "", "", "" },
    ...
    BRDPyromantLoregrain = {
		...
		{ 0, "", "", "" },
		{ 11000, "inv_misc_key_08", "=q1=Shadowforge Key", "=ds=#m4#", "100%" },
        };
	...
	BRDArenaSet = {
		{ 11729, "inv_helmet_01", "=q3=Savage Gladiator Helm", "Arena, Hedrum the Creeper", "15%" },
		{ 11726, "inv_chest_chain_15", "=q4=Savage Gladiator Chain", "Arena, Gorosh the Dervish", "15%" },
		{ 11728, "inv_pants_03", "=q3=Savage Gladiator Leggings", "Arena, Ok'thor the Breaker", "15%" },
		{ 11731, "inv_boots_01", "=q3=Savage Gladiator Greaves", "Arena, Anub'shiah", "15%" },
		{ 11730, "inv_gauntlets_04", "=q3=Savage Gladiator Grips", "Arena, Eviscerator", "15%" },
	};
  ...
  -------------------------------------
    ...
    STRATStratholmeCourier={
		...
		{ 0,"","","" },
		{ 13393,"inv_mace_01","=q3=Malown's Slam","=ds=#s14#", "19%" },
		{ 13388,"inv_chest_leather_10","=q3=The Postmaster's Tunic","=ds=#s14#", "19%" },
		{ 13389,"inv_pants_06","=q3=The Postmaster's Trousers","=ds=#s14#", "19%" },
		{ 13391,"inv_boots_02","=q3=The Postmaster's Treads","=ds=#s14#", "19%" },
		{ 13392,"inv_jewelry_ring_23","=q3=The Postmaster's Seal","=ds=#s14#", "19%" },
		{ 13390,"inv_misc_bandage_15","=q3=The Postmaster's Band","=ds=#s14#", "3%" },
        };
    ...
    NAXSapphiron = {
        ...
        { 23242, "INV_weapon_hand_03", "=q4=Claw of the Frost Wyrm", "Off Hand, Fist Weapon" },
    ...
    NAXKelThuzard = {
        { 23577, "INV_sword_62", "=q4=The Hungering Cold", "One-Hand Sword" },
        ...
        { 22799, "inv_staff_15", "=q4=Soulseeker", "Two-Hand Staff" },
        { 0, "", "", "" },
        { 0, "", "", "" },
        { 0, "", "", "" },
        { 0, "", "", "" },
