...
ATLASLOOT_ERRORTOOLTIP_L3 = "這個物品並不安全. 如要安全的檢視這個物品並且\n避免斷線, 你必須在當前的伺服器中曾見過該物品. \n這是暴雪自 1.10 更新之後增加的限制.";
ATLASLOOT_ERRORTOOLTIP_L4 = "你可以按下滑鼠右鍵來嘗試向伺服器查詢\n該物品的資訊, 然而你將可能因此斷線.";

ATLASLOOT_SAFE_MESSAGE = 	"現在安全了."; 
